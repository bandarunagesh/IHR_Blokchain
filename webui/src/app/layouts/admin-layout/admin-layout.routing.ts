...
import { ProTableListComponent } from 'app/pro-table-list/pro-table-list.component';
...
export const AdminLayoutRoutes: Routes = [
    ...
    { path: 'prouser-profile', component: ProUserProfileComponent },
    { path: 'protable-list', component: ProTableListComponent },
